...
class RegionDistrictsListViewModelImpl @Inject constructor(
    ...
    MviViewModel<List<CongregationListItem>, UiState<List<CongregationListItem>>, RegionDistrictsListUiAction, RegionDistrictsListUiSingleEvent>(
        state = state
    ) {
    ...
    override suspend fun handleAction(action: RegionDistrictsListUiAction): Job {
        ...
        val job = when (action) {
            ...
            is RegionDistrictsListUiAction.EditPayer -> {
                submitSingleEvent(
                    RegionDistrictsListUiSingleEvent.OpenPayerScreen(
            ...
            is RegionDistrictsListUiAction.DeletePayer -> {
                deletePayer(action.payerId)
            }
            is RegionDistrictsListUiAction.FavoritePayer -> {
    ...
    companion object {
        fun previewModel(ctx: Context) =
            object : RegionDistrictsListViewModel {
                ...
                override val singleEventFlow = Channel<RegionDistrictsListUiSingleEvent>().receiveAsFlow()
