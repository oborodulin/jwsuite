...
private const val TAG = "Presentation_Dashboard.DatabaseSendDialog"

@Composable
fun DatabaseSendDialog(
    isShow: Boolean,
    title: String,
    ...
    if (isShow) {
        LaunchedEffect(Unit) {
            if (LOG_UI_COMPONENTS) Timber.tag(TAG).d("DatabaseSendDialog -> LaunchedEffect()")
