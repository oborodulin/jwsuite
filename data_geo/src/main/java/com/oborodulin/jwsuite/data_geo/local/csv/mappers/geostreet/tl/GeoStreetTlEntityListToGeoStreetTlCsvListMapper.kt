...
class GeoStreetTlEntityListToGeoStreetTlCsvListMapper(mapper: GeoStreetTlEntityToGeoStreetTlCsvMapper) :
    ListMapperImpl<GeoStreetTlEntity, GeoStreetTlCsv>(mapper)