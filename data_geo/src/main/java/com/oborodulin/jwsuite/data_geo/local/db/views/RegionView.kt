...
@DatabaseView(
    ...
    value = """
    SELECT r.regionId, ifnull(rtl.regionTlCode, r.regionCode) AS regionCode, r.regionType, r.isRegionTypePrefix, 
            r.regionGeocode, r.regionOsmId, r.${GeoRegionEntity.PREFIX}latitude, r.${GeoRegionEntity.PREFIX}longitude,
            r.rCountriesId,
