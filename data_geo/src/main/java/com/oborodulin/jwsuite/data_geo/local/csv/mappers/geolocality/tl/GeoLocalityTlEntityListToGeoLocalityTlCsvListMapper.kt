...
class GeoLocalityTlEntityListToGeoLocalityTlCsvListMapper(mapper: GeoLocalityTlEntityToGeoLocalityTlCsvMapper) :
    ListMapperImpl<GeoLocalityTlEntity, GeoLocalityTlCsv>(mapper)