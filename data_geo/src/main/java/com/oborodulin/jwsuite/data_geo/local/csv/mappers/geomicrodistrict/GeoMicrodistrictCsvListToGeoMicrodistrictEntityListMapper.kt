...
class GeoMicrodistrictCsvListToGeoMicrodistrictEntityListMapper(mapper: GeoMicrodistrictCsvToGeoMicrodistrictEntityMapper) :
    ListMapperImpl<GeoMicrodistrictCsv, GeoMicrodistrictEntity>(mapper)