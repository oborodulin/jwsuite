...
interface StreetMicrodistrictViewModel :
    CheckedListDialogViewModeled<StreetMicrodistrictsUiModel, StreetMicrodistrictUiAction, UiSingleEvent, StreetMicrodistrictFields, List<MicrodistrictsListItem>> {
