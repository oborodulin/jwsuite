...
interface StreetLocalityDistrictViewModel :
    CheckedListDialogViewModeled<StreetLocalityDistrictsUiModel, StreetLocalityDistrictUiAction, UiSingleEvent, StreetLocalityDistrictFields, List<LocalityDistrictsListItem>> {
