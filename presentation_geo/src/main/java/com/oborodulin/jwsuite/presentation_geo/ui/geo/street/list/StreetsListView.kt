...
fun StreetsListView(
    ...
    LaunchedEffect(Unit) {
        Timber.tag(TAG).d("StreetsListView: LaunchedEffect() AFTER collect ui state flow")
...
fun StreetsList(
    ...
    Timber.tag(TAG).d("StreetsList(...) called")
    ...
    if (streets.isNotEmpty()) {
        LazyColumn(
            ...
            items(streets.size) { index ->
                streets[index].let { street ->
        ...
        Text(
            text = stringResource(R.string.streets_list_empty_text),
