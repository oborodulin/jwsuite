...
@DatabaseView(
    ...
    value = """
    SELECT m.*, mr.*, r.* FROM ${MemberRoleEntity.TABLE_NAME} mr JOIN ${RoleEntity.TABLE_NAME} r ON r.roleId = mr.mrRolesId
                        JOIN ${MemberEntity.TABLE_NAME} m ON m.memberId = mr.mrMembersId
