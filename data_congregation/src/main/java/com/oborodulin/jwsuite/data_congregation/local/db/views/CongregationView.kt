...
SELECT c.*, 
        lv.localityId AS ${CongregationEntity.PX_LOCALITY}localityId, lv.localityCode AS ${CongregationEntity.PX_LOCALITY}localityCode, lv.localityType AS ${CongregationEntity.PX_LOCALITY}localityType, 
            lv.localityGeocode AS ${CongregationEntity.PX_LOCALITY}localityGeocode, lv.localityOsmId AS ${CongregationEntity.PX_LOCALITY}localityOsmId, 
            lv.${GeoLocalityEntity.PREFIX}latitude AS ${CongregationEntity.PX_LOCALITY}${GeoLocalityEntity.PREFIX}latitude,
            lv.${GeoLocalityEntity.PREFIX}longitude AS ${CongregationEntity.PX_LOCALITY}${GeoLocalityEntity.PREFIX}longitude, 
