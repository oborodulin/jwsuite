...
object Constants {
    ...
    // Member:
    const val PX_MEMBER_CONGREGATION = "mc_"
    const val PX_MEMBER_REGION = PX_MEMBER_CONGREGATION + PX_CONGREGATION_REGION
    const val PX_MEMBER_REGION_DISTRICT = PX_MEMBER_CONGREGATION + PX_CONGREGATION_REGION_DISTRICT
    const val PX_MEMBER_LOCALITY = PX_MEMBER_CONGREGATION + PX_CONGREGATION_LOCALITY
}