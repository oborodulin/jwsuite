...
@DatabaseView(
    ...
    value = """
SELECT tsv.*, tv.*, h.* 
FROM ${TerritoryStreetView.VIEW_NAME} tsv JOIN ${TerritoryView.VIEW_NAME} tv ON tv.territoryId = tsv.tsTerritoriesId AND tv.${TerritoryEntity.PX_LOCALITY}localityLocCode  = tsv.streetLocCode
