...
class TerritoryStreetEntityListToTerritoryStreetCsvListMapper(mapper: TerritoryStreetEntityToTerritoryStreetCsvMapper) :
    ListMapperImpl<TerritoryStreetEntity, TerritoryStreetCsv>(mapper)