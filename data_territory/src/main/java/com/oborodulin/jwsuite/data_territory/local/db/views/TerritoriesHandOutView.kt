...
@DatabaseView(
    ...
    value = """
SELECT tv.*, m.*, ct.ctCongregationsId, ifnull(tps.isPrivateSector, $DB_FALSE) AS isPrivateSector, rld.handOutTotalDays, 
...
FROM ${TerritoryView.VIEW_NAME} tv JOIN ${CongregationTerritoryCrossRefEntity.TABLE_NAME} ct 
    ...
    LEFT JOIN ${MemberEntity.TABLE_NAME} m ON m.memberId = rld.tmcMembersId
