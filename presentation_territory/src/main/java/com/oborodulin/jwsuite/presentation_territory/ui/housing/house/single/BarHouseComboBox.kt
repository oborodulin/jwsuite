...
private const val TAG = "Housing.BarHouseComboBox"

@Composable
fun BarHouseComboBox(
    ...
    Timber.tag(TAG)
        .d("BarHouseComboBox(...) called: streetId = %sж territoryId = %s", streetId, territoryId)
    ...
    BarComboBoxComponent(
        ...
        loadListUiAction = HousesListUiAction.Load(streetId = streetId, territoryId = territoryId),
        isShowListDialog = isShowListDialog,
        onShowListDialog = onShowListDialog,
        onDismissListDialog = onDismissListDialog,
        onShowSingleDialog = { singleViewModel.onOpenDialogClicked() },
        placeholderResId = R.string.house_placeholder,
