...
class HouseViewModelImpl @Inject constructor(
    ...
    DialogSingleViewModel<HouseUi, UiState<HouseUi>, HouseUiAction, UiSingleEvent, HouseFields, InputWrapper>(
    ...
    private fun saveHouse(): Job {
        ...
        val houseUi = HouseUi(
            ...
            buildingNum = if (buildingNum.value.value.isNotEmpty()) buildingNum.value.value.toInt() else null,
            ...
            houseEntrancesQty = if (houseEntrancesQty.value.value.isNotEmpty()) houseEntrancesQty.value.value.toInt() else null,
            floorsByEntrance = if (floorsByEntrance.value.value.isNotEmpty()) floorsByEntrance.value.value.toInt() else null,
            roomsByHouseFloor = if (roomsByHouseFloor.value.value.isNotEmpty()) roomsByHouseFloor.value.value.toInt() else null,
            estimatedRooms = if (estimatedRooms.value.value.isNotEmpty()) estimatedRooms.value.value.toInt() else null,
