...
private const val TAG = "Territoring.TerritoryReportHousesListView"

@Composable
fun TerritoryReportHousesListView(
    housesListViewModel: TerritoryReportHousesListViewModelImpl = hiltViewModel(),
    ...
    Timber.tag(TAG).d(
        "TerritoryReportHousesListView(...) called: streetInput = %s; territoryInput = %s; territoryStreetInput = %s",
    ...
    LaunchedEffect(
        ...
        Timber.tag(TAG)
            .d("TerritoryReportHousesListView -> LaunchedEffect() BEFORE collect ui state flow")
    ...
    LaunchedEffect(Unit) {
        Timber.tag(TAG)
            .d("TerritoryReportHousesListView -> LaunchedEffect() AFTER collect single Event Flow")
...
fun PreviewHousesEditableList() {
    JWSuiteTheme {
        Surface {
            /*StreetHousesList(
                houses = TerritoryReportHousesListViewModelImpl.previewList(LocalContext.current),
                onEdit = {},
                onDelete = {},
                onClick = {}
            )*/
