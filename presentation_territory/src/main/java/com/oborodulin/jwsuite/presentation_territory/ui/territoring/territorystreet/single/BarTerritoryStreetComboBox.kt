...
private const val TAG = "Territoring.BarTerritoryStreetComboBox"

@Composable
fun BarTerritoryStreetComboBox(
    ...
    Timber.tag(TAG).d("BarTerritoryStreetComboBox(...) called")
    ...
    BarComboBoxComponent(
        ...
        placeholderResId = R.string.territory_street_placeholder,
...
@Composable
fun PreviewBarTerritoryStreetComboBox() {
    JWSuiteTheme {
        Surface {
