...
private const val TAG = "Common.ui.TerritoryStreetDialog"

@Composable
fun <T : ListItemModel, L : List<T>, A : UiAction, E : UiSingleEvent> TerritoryStreetDialog(
    isShow: Boolean,
    title: String,
    ...
    if (isShow) {
        LaunchedEffect(Unit) {
            Timber.tag(TAG)
                .d("TerritoryStreetDialog: LaunchedEffect() BEFORE collect ui state flow")
...
@Composable
fun PreviewTerritoryStreetDialog() {
