...
sealed class MemberInputEvent(val value: String) : Inputable {
    ...
    data class MemberCongregationId(val input: String = "") : MemberInputEvent(input)
    data class ActivityDate(val input: String) : MemberInputEvent(input)
    data class MemberMovementId(val input: String = "") : MemberInputEvent(input)
