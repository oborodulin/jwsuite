...
import com.oborodulin.jwsuite.data.util.Constants.PX_TERRITORY_LD_REGION_DISTRICT
import com.oborodulin.jwsuite.data.util.Constants.PX_TERRITORY_LOCALITY
import com.oborodulin.jwsuite.data.util.Constants.PX_TERRITORY_MICRODISTRICT
import com.oborodulin.jwsuite.data.util.Constants.PX_TERRITORY_M_LOCALITY
import com.oborodulin.jwsuite.data.util.Constants.PX_TERRITORY_M_LOCALITY_DISTRICT
import com.oborodulin.jwsuite.data.util.Constants.PX_TERRITORY_M_REGION
...
SELECT t.*, cv.*, tc.*,
        rv.regionId AS ${PX_TERRITORY_REGION}regionId, rv.regionCode AS ${PX_TERRITORY_REGION}regionCode, 
            rv.regionTlId AS ${PX_TERRITORY_REGION}regionTlId, rv.regionLocCode AS ${PX_TERRITORY_REGION}regionLocCode, rv.regionName AS ${PX_TERRITORY_REGION}regionName,
            rv.regionsId AS ${PX_TERRITORY_REGION}regionsId, 
        ...
        rvl.regionId AS ${PX_TERRITORY_LD_REGION}regionId, rvl.regionCode AS ${PX_TERRITORY_LD_REGION}regionCode, 
            rvl.regionTlId AS ${PX_TERRITORY_LD_REGION}regionTlId, rvl.regionLocCode AS ${PX_TERRITORY_LD_REGION}regionLocCode, rvl.regionName AS ${PX_TERRITORY_LD_REGION}regionName,
            rvl.regionsId AS ${PX_TERRITORY_LD_REGION}regionsId, 
        ...
        rvm.regionId AS ${PX_TERRITORY_M_REGION}regionId, rvm.regionCode AS ${PX_TERRITORY_M_REGION}regionCode, 
            rvm.regionTlId AS ${PX_TERRITORY_M_REGION}regionTlId, rvm.regionLocCode AS ${PX_TERRITORY_M_REGION}regionLocCode, rvm.regionName AS ${PX_TERRITORY_M_REGION}regionName,
            rvm.regionsId AS ${PX_TERRITORY_M_REGION}regionsId, 
