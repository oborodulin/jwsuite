...
@DatabaseView(
    ...
    value = """
SELECT lv.*, ldv.*, mdv.*, sv.* FROM ${StreetView.VIEW_NAME} sv JOIN ${GeoLocalityView.VIEW_NAME} lv ON lv.${PX_LOCALITY}localityId = sv.sLocalitiesId AND lv.${PX_LOCALITY}localityLocCode = sv.streetLocCode
