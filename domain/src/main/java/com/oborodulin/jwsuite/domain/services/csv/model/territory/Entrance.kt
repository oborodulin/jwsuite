...
data class Entrance(
    ...
    val house: com.oborodulin.jwsuite.domain.services.csv.model.territory.House,
    val territory: com.oborodulin.jwsuite.domain.services.csv.model.territory.Territory? = null,
    val entranceNum: Int,
    ...
    val floors: List<com.oborodulin.jwsuite.domain.services.csv.model.territory.Floor> = emptyList(),
    val rooms: List<com.oborodulin.jwsuite.domain.services.csv.model.territory.Room> = emptyList()
) : DomainModel() {
    val entranceFullNum =
