...
private class ActivityLifecycleCallbacks(private val locale: Locale) :
...
private class ApplicationCallbacks(private val context: Context, private val locale: Locale) :
    ComponentCallbacks {
